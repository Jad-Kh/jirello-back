import { CommunityPermissionsResponseModel } from "../responses/models/community/utils/CommunityPermissionsResponseModel.js";
...
const createPermissionsResponse = (permissionSet) => {
    return new CommunityPermissionsResponseModel({
