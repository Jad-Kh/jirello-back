...
import { IRequest } from "./api.js";

type PermissionEntryObject = {
    domain: string;
    permissions: number[];
};

type PermissionEntry = PermissionEntryObject | ((req: IRequest<any, "user">) => PermissionEntryObject);
...
export const PERMISSIONS_MAP: PermissionsMapType = {
    // Auth Routes
