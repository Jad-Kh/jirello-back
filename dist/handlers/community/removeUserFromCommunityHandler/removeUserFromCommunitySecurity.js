...
exports.removeUserFromCommunitySecurity = void 0;
...
const removeUserFromCommunitySecurity = (res, community, user, requestModel) => {
    ...
    if (!community.userIds.includes(requestModel?.userId) || !community.ownerIds.includes(requestModel?.ownerId)) {
        return res.status(CommunityErrorResponses_ts_1.CommunityErrorResponses.COMMUNITY_USER_NOT_FOUND.code)
            .json((0, errorResponsePresenter_ts_1.prepareErrorResponse)(CommunityErrorResponses_ts_1.CommunityErrorResponses.COMMUNITY_USER_NOT_FOUND, null));
    }
    return true;
};
exports.removeUserFromCommunitySecurity = removeUserFromCommunitySecurity;
