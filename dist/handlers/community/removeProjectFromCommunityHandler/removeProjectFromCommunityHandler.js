...
exports.removeProjectFromCommunityHandler = void 0;
...
const removeProjectFromCommunitySecurity_ts_1 = require("./removeProjectFromCommunitySecurity.ts");
...
const removeProjectFromCommunityHandler = async (req, res, next) => {
    try {
        ...
        if ((0, security_ts_1.checkSecurity)((0, removeProjectFromCommunitySecurity_ts_1.removeProjectFromCommunitySecurity)(res, community, project))) {
            await community_ts_1.CommunityQueries.removeProjectFromCommunityQuery(requestModel.communityId, requestModel.projectId);
            await project_ts_1.ProjectQueries.updateProjectCommunityQuery(requestModel.projectId, requestModel.communityId);
            return next();
        }
    }
    catch (error) {
        (0, errorLogging_ts_1.catchError)(error, res, exports.removeProjectFromCommunityHandler.name);
    }
};
exports.removeProjectFromCommunityHandler = removeProjectFromCommunityHandler;
