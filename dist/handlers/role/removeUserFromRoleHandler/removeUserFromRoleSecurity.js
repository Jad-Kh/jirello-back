...
exports.removeUserFromRoleSecurity = void 0;
...
const removeUserFromRoleSecurity = (res, role, user, userId) => {
    ...
    if (!role.userIds.includes(userId)) {
        return res.status(RoleErrorResponses_ts_1.RoleErrorResponses.ROLE_USER_NOT_FOUND.code)
            .json((0, errorResponsePresenter_ts_1.prepareErrorResponse)(RoleErrorResponses_ts_1.RoleErrorResponses.ROLE_USER_NOT_FOUND, null));
    }
    return true;
};
exports.removeUserFromRoleSecurity = removeUserFromRoleSecurity;
